...
(function() {
  var Board, CursorShape, NodeShape, Viewport, board_6x4, edgeWidth, nodeRadius, viewport, windowSize, windowSizeAtReady, windowSizeAtResize;
  ...
  $(document).ready(function() {
    var board, cursorPosition, cursorShape, logicalToPhysical, shapeIdToNodeShapeMap, shapesUnderPoint, stage, stageUpdate;
    console.log("ready");
