...
(function() {
  var Board, board_6x4, edgeWidth, nodeRadius, viewPort, windowSize, windowSizeAtReady, windowSizeAtResize;
  ...
  $(document).ready(function() {
    var board, cursor, cursorPosition, edgeShapeMap, edgesUnderPoint, logicalToPhysical, micrometerToPixel, nodeShapeMap, nodesUnderPoint, shapeIdToEdgeMap, shapeIdToNodeMap, shapesUnderPoint, stage, stageUpdate;
    console.log("ready");
