...
(function() {
  var board_6x4, edgeWidth, nodeRadius, viewPort, windowSize, windowSizeAtReady, windowSizeAtResize;
  ...
  $(document).ready(function() {
    var board, cursor, cursorPosition, edgeMap, edgeShapeMap, edges, edgesUnderPoint, logicalToPhysical, micrometerToPixel, nodeMap, nodeShapeMap, nodes, nodesUnderPoint, ref, ref1, shapeIdToEdgeMap, shapeIdToNodeMap, shapesUnderPoint, stage, stageUpdate;
    console.log("ready");
