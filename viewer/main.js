...
(function() {
  var Board, Context, CursorShape, EdgeShape, NodeShape, Viewport, board_6x4, context, windowSize, windowSizeAtReady, windowSizeAtResize;
  ...
  Context = (function() {
    function Context() {
      this.nodeRadius = new Bacon.Bus();
      this.edgeWidth = new Bacon.Bus();
      this.viewport = new Bacon.Bus();
    }
  ...
  $(document).ready(function() {
    ...
    offsetStream.onValue(function(e) {
      return context.viewport.push(new Viewport({
        scale: 1.0 / 1000 * 20,
        offsetX: e.x,
        offsetY: e.y
      }));
